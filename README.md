...
## Script that creates isolated VPC with public and private subnet and launches EC2 instance for the web-app in the public subnet. It also configures SG rules:
